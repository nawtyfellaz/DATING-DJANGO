...
class Match(models.Model):
	user_a = models.ForeignKey(User, related_name='match_user_a', on_delete=models.CASCADE)
	user_b 	= models.ForeignKey(User, related_name='match_user_b', on_delete=models.CASCADE)
